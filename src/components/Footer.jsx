    ...
    <div className="w-screen h-fit py-10 px-6 md:px-20 flex flex-col bg-black gap-10">
        <div className="flex flex-row gap-10 items-center justify-between">
            ...
            <div className="flex flex-row gap-4">
                <img src="/whatsappa.svg" alt="logo" className="w-[20px] object-cover cursor-pointer hover:scale-110 transition-all duration-300" />
                <img src="/instagram.svg" alt="logo" className="w-[20px] object-cover cursor-pointer hover:scale-110 transition-all duration-300" />
            </div>
        </div>
