    ...
    <div className="w-screen h-fit py-10 px-6 md:px-20 flex flex-col bg-black gap-10">
        <div className="flex flex-row gap-10 items-center justify-between">
            ...
            <div className="flex flex-row gap-4">
                <img onClick={() => window.open('https://wa.link/7k63fi', '_blank')} src="/whatsapp.svg" alt="WhatsApp" className="w-[20px] object-cover cursor-pointer hover:scale-110 transition-all duration-300" />
