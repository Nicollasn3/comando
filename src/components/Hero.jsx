const Hero = () => {
  return (
    <div className='relative h-[85vh] w-dvh overflow-hidden'>
        <div className='relative z-10 h-full flex flex-col justify-end items-center px-6 py-11  gap-5'>
            <div className='flex flex-col gap-2 xl:w-[700px] md:w-[500px]'>
                ...
                <h1 className='text-zinc-200 xl:text-lg md:text-base text-sm text-center font-medium'>Chega de portões travando, câmeras falhando ou moradores vulneráveis. A Comando Security traz a tecnologia que protege você 24h por dia, 7 dias por semana.</h1>
            </div>
