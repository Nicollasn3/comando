...
const CardProblema = ({ imageUrl, iconUrl, title, description }) => {
  ...
  return (
    <div className='relative flex flex-col-reverse md:flex-row md:max-w-[1000px] md:items-center mx-auto md:justify-center w-full h-fit overflow-hidden'>
      ...
      <div
        className={`z-0 flex flex-col gap-2 w-full md:w-1/2 h-[243px] px-9 items-start align-middle justify-center bg-black transition-transform duration-[1000ms] md:duration-[1300ms] ease-out will-change-transform ${
          revealed
